...
% reading h and Delta matrices corresponding to Pu240 from DIRHB
h     = struct2array( load( '../data/Pu240/DIRHB/h.mat'     ) );
Delta = struct2array( load( '../data/Pu240/DIRHB/Delta.mat' ) );
n     = length(h);
